 ...
 <IconsContainer>
  <div style={{display:"grid" , gridTemplateColumns:"1fr 1fr 1fr" , justifyContent:"center" , marginLeft:"20px" , gap:"10px"}}>
   ...
   <div> <FaTelegram style={IconStyle} /> <span style={{color:"black" , fontFamily:"Raleway" , display:"block"}}>Telegram</span></div> 
     ...
     <div>   <FaPhone style={{ ...IconStyle, color: '#004358' }} onClick={handlePhoneClick} /><span style={{color:"black" , fontFamily:"Raleway", display:"block"}}>call us</span></div>
     <div>    <a href={`mailto:${emailAddress}`} style={{textDecoration:"none"}} ><FaEnvelope style={{ ...IconStyle, color: '#004358' }} /><span style={{color:"black" , fontFamily:"cursive", display:"block"}}>Mail us</span></a></div>
      </div>
    </IconsContainer>
 <Hr></Hr>
    <Who>
    Designed by <span style={{color: '#004358',fontFamily: "Poppins", }}>HULU GENERALS</span>
  </Who>
 </Container>
